let removeBtn = document.querySelector(".button-to-remove");
let mainCont = document.querySelector(".home-content");
let addBtn = document.querySelector(".button-to-add");

let modalCont = document.querySelector(".themes");
...
for(let i = 0 ;  i < toolboxColor.length ; i++){
    toolboxColor[i].addEventListener("click" , (e) =>{
        ...
        let allTicketsCont = document.querySelectorAll(".listContent");
...
function createTicket(ticketColor, ticketTask, ticketID) {
    ...
    ticketCont.setAttribute("class", "listContent");
    ticketCont.innerHTML = `
    <div class = "colorOfTicket ${ticketColor}"></div>
    <div class="idOfTicket">#${ticketID}</div>
    <div class="listSpace">${ticketTask}</div>
...
function handleLock(ticket , id) {
    ...
    let ticketTaskArea = ticket.querySelector(".listSpace");
...
function handleColor(ticket ,id) {
    let ticketColor = ticket.querySelector(".colorOfTicket");
